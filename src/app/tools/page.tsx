...
const tools = [
  ...
  { 
    ...
    description: 'An app designed for the House Of Wisdom to track volunteer hours and manage community projects effectively.',
      ...
      <div className="container mx-auto px-6 py-24">
        ...
        >
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-2xl">
            Explore our collection of projects built to solve real-world problems and make a positive impact in our community.
          </p>
        </motion.div>
        ...
        <div className="space-y-32">
          {tools.map((tool, index) => (
            <motion.div 
              ...
              className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} justify-between items-center gap-12`}
              onMouseEnter={() => setHoveredProject(tool.name)}
